...
define("examples/lucky/1.0.0/data-debug", [], [ "刘克东", "郭霆", "李晓彦", "王中华", "吕晓晨", "朱川邻", "黄玲", "梅双杰", "谭清红", "姚剑锋", "刘妍妍", "张勇", "周伟", "欧阳琴", "周利文", "彭通", "喻世超", "付伟", "郭小兵", "傅家俊", "云长清", "郑文超", "项梦", "向双双", "马俊", "张亿", "钟旋", "杨晨", "陶瞳瞳", "李立", "向阳", "张学春", "张立兵", "李振波", "吴勇", "吴保杰", "饶志坤", "朱世权", "成志民" ]);
